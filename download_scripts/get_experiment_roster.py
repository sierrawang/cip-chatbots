...
default_roster_filename = '../experiment_roster/experiment_rosters/experiment_roster_drop.csv'

def load_experiment_roster(roster_filename=default_roster_filename):
...
def get_experiment_roster(roster_filename=default_roster_filename):
    experiment_roster = load_experiment_roster(roster_filename)
    return experiment_roster['user_id'].to_list()

def get_section_ids(roster_filename=default_roster_filename):
    experiment_roster = load_experiment_roster(roster_filename)
