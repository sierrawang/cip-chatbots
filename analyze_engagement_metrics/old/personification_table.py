...
from rosters_helpers import get_personified_students, get_nonpersonified_students, get_student_data
...
from confounds_helpers import get_female, get_age, get_in_usa, get_personified, get_changed_section, get_ide
...
def agent_vs_tool_table():
    ...
    output_table(rosters, engagement_metrics, caption, label, './tables/personification_table.tex')
