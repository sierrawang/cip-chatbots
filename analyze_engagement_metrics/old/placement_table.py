...
from rosters_helpers import get_basic_personified_students, get_basic_nonpersonified_students, get_ide_personified_students, get_ide_nonpersonified_students, get_student_data
...
from confounds_helpers import get_female, get_age, get_in_usa, get_personified, get_changed_section
...
def lessons_vs_ide_table():
    ...
    output_table(rosters, engagement_metrics, caption, label, './tables/placement_table.tex')
